...
|---|---|---|
| Check JSON and exits | [`output.rs`](../../crates/tirith-core/src/output.rs): schema 3; [`c00_cli_compatibility.rs`](../../crates/tirith/tests/c00_cli_compatibility.rs), [`cli-contracts.toml`](../../tests/fixtures/c00/cli-contracts.toml) freeze representative keys/actions/exits | Eight actual released 0.4.2 command captures now have [compact fixtures](../../tests/fixtures/cycle-0.4.2/README.md); wider captures and explicit migrations remain |
...
| Trust store | Core `policy.rs` and CLI `trust.rs` tests cover user/repo scope, malformed entries, TTL and protected writes | Five actual released 0.4.2/new-grant assertions are captured in [cycle fixtures](../../tests/fixtures/cycle-0.4.2/README.md); broader copy/move/expiry/native cases remain |
