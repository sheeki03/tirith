...
| Workspace/platform CI | At `c3445508`, Windows compiles and passes native standard-account dashboard/ACL/cleanup checks; native ARM GNU/musl, all six release builds and fourteen fuzz jobs pass; see [platform CI](verification.md#platform-ci-and-corrective-checks-2026-09-21) | Workspace tests fail the subsequently corrected backtick case and Windows path fixture; npm assembly fails the subsequently corrected README expectation. Fresh matching CI must pass; no complete platform/release acceptance is claimed |
