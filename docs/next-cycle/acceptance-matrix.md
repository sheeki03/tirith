...
| Workspace/platform CI | All five workflows pass on `87c0fdee`, including Linux, macOS, Windows and Rust 1.83 CI, six release target builds, native ARM, fuzzing and benchmarks; see [platform CI](verification.md#platform-ci-and-corrective-checks-2026-09-21) | The later npm integration and materialization schema migration require matching native and platform checks. Prior CI does not certify these changes or close final release acceptance |
